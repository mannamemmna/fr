...
class LiveEngine:
    ...
    def execute_instant(self, symbol: str, amount_usd: float, side_bybit: str, side_kucoin: str, leverage: int = 2) -> Dict[str, Any]:
        ...
        position = {
            ...
            "entry_delta": opp.get("delta_pct", 0),
            "entry_raw_fr_diff": opp.get("raw_fr_diff", 0),
            "bybit_next_ts": opp.get("bybit_next_ts") or 0,
            "kucoin_next_ts": opp.get("kucoin_next_ts") or 0,
