...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    mode = "\U0001F4C4 Paper (Simulasi)" if PAPER_MODE else "\U0001F534 Live (Real)"
    msg = (
        f"\U0001F916 *FR Bot — Funding Rate Arbitrage*\n\n"
        ...
        f"\U0001F916 *Automation (Auto-Trade)*\n"
        ...
        f"\u2696\uFE0F *Rebalance*\n"
        f"`/rebalance` — Cek saldo kedua exchange dan status keseimbangan.\n"
        f"`/rebalance on` — Aktifkan auto rebalance.\n"
        f"`/rebalance off` — Nonaktifkan auto rebalance.\n\n"
        f"\U0001F6E0\uFE0F *Dasar*\n"
